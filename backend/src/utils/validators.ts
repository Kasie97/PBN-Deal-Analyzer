import { AnalyzeDealPayload } from "../types/index.js";

export function validateAnalyzeDealPayload(
  ...
  if (
    ...
    throw new Error(
      "Deal data is required for initial analysis"
    );
  }
