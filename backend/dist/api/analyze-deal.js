...
import { loadConversation, saveConversation } from "../utils/supabase.js";
...
export async function analyzeDeal(payload) {
    ...
    const { sessionId, dealData, followUpQuestion } = payload;
    let conversationHistory = await loadConversation(sessionId);
    conversationHistory =
    ...
    if (!followUpQuestion &&
        ...
        const initialPrompt = buildInitialPrompt(dealData);
...
`
    ...
    try {
        ...
        console.error("Failed to parse Claude JSON:", rawResponse);
...
// import Anthropic from "@anthropic-ai/sdk";
// import { AnalyzeDealPayload, AnalyzeDealResponse, ConversationMessage } from "../types/index.js";
// import { buildInitialPrompt } from "../utils/prompts.js";
// import { loadConversation, saveConversation } from "../utils/supabase.js";
// const client = new Anthropic({
//   apiKey: process.env.ANTHROPIC_API_KEY
...
//     (item) => item.type === "text"
//   );
//   const claudeResponse = textBlock?.text || "No response generated.";
//   conversationHistory.push({
//     role: "assistant",
